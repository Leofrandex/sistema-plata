import { mapRouteEvents } from '@hospiwaste/shared/components/supabase-hydrator'
import type { RouteEventRow, RouteContainerLink } from '@hospiwaste/shared/lib/supabase/queries'
