...
>   - **Parche manual de campo 2026-07-06:** para una prueba se re-habilitaron los tachos `001` y `003` anulando sus recepciones del 05-jul. **Obsoleto:** ese mismo día se hizo un **reset total de datos operativos** (ver `logs/2026-07-06-reset-datos-piloto.md`) que borró TODAS las recepciones, recorridos, etc. Ya no hay nada que restaurar. El bug de fondo sigue vigente.
