...
export function HomeHero({ name }: { name?: string }) {
  ...
  return (
    <section className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary via-primary to-accent p-6 text-primary-foreground ring-1 ring-foreground/10">
      ...
      <div className="relative flex flex-col gap-2">
        ...
        <p className="text-sm text-primary-foreground/80 first-letter:uppercase">{dateLabel}</p>
      </div>
    </section>
  )
}
